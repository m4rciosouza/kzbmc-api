...
/**
 * This is the model class for table "projeto_canvas_compartilhado_lean".
 *
 * @property integer $id
 * @property integer $id_projeto_canvas
 * @property integer $id_usuario
 */
class ProjetoCanvasCompartilhadoLean extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'projeto_canvas_compartilhado_lean';
    }
    ...
    {
    	return $this->hasOne(ProjetoCanvasLean::className(), ['id' => 'id_projeto_canvas']);
    }
